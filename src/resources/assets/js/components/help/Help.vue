<template>
    <div class="help">
        <div class="help-icon" :style="iconStyle">
            <button class="help-icon__button" title="Guide">
                <svg @click.prevent="openVideoDialog"
                 xmlns="http://www.w3.org/2000/svg"
                 width="34" height="34"
                 x="0px" y="0px"
                 viewBox="0 0 496.158 496.158" style="enable-background:new 0 0 496.158 496.158;" xml:space="preserve">
<path d="M496.158,248.085c0-137.022-111.069-248.082-248.075-248.082C111.07,0.003,0,111.063,0,248.085
	c0,137.001,111.07,248.07,248.083,248.07C385.089,496.155,496.158,385.086,496.158,248.085z"/>
        ...
        <help-video v-if="showVideoDialog" :video-options="videoOptions" :show-dialog="showVideoDialog"
