...
export default {
    ...
    methods: {
        change(val) {
            this.$confirm(`Are you sure you want to ${val ? 'enable' : 'disable'} "Can Collect Payments" status for ${this.providerName}?`, 'Warning', {
                ...
                .then(() => {
                    ...
                    const data = {
                        isCollectPaymentAvailable: val,
                        providerId: this.providerId,
                    };

                    axios({
                        method: 'post',
                        url: '/dashboard/doctors/is-collect-payment-available',
                        data: data,
                    })
                        .then(() => {
