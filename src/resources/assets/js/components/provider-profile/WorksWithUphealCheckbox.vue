...
export default {
    ...
    methods: {
        change(val) {
            if (val) {
                this.handleCheckboxEnable();
            } else {
                this.handleCheckboxDisable();
            }
        },

        handleCheckboxEnable() {
            this.$confirm(`Are you sure you want to enable "Works with Upheal" status for ${this.providerName}?`, 'Warning', {
                ...
                .then(() => {
                    ...
                    const data = {
                        worksWithUpheal: true,
                        providerId: this.providerId,
                    };

                    axios({
                        method: 'post',
                        url: '/dashboard/doctors/works-with-upheal',
                        data: data,
                    })
                        .then(() => {
        ...
        handleCheckboxDisable() {
            this.$confirm('This operation is currently not allowed. To disable therapist\'s Upheal account please contact the IT department.', 'Warning', {
