                        ...
                        <div class="row last-row">
                            ...
                            <div class="col-lg-12">
                                <h4 class="modal-title">
                                    REQUEST FOR REAUTHORIZATION – 1st renewal ONLY
                                </h4>
                            </div>
                            <div class="col-lg-12">
                                <p>
                                    After 1st 10 sessions: Fax form to#: 888-896-4727
                                </p>
                                <p>
                        ...
                        <div class="section section-add-note">
                            <form class="form-note from-document" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <!--&gt;</document-textarea>-->
                                    <!--<document-textarea-->
                                            <!--name="discharge_treatment"-->
                                            <!--label="Recommend Discharge"-->
                                            <!--size="col-md-4"-->
                                            <!--v-model="form_data.discharge_treatment"-->
                                            <!--@change="setHasValue"-->
                                            <!--:disabled="statuses.editingDisabled"-->
                                    <!--&gt;</document-textarea>-->
                                    ...
                                    <table class="table table-bordered document-table">
                                        ...
                                        <tr>
                                            <td scope="row" class="param-td-title">
                                                <document-textarea
                                                        name="first_renewal"
                                                        label="This is first renewal after 10 sessions or 6 months, whichever came first"
                                                        v-model="form_data.first_renewal"
                                                        @change="setHasValue"
                                                        :disabled="statuses.editingDisabled"
                                                ></document-textarea>
                                            </td>
                                            <td class="param-td">
                                                <select class="dropdown-form-control"
                                                        @change="setHasValue"
                                                        v-model="form_data.first_renewal_select"
                                                        :disabled="statuses.editingDisabled"
                                                >
                                                    <option value="None"></option>
                                                    <option>Yes</option>
                                ...
                                <br/>
                                <div class="row ">
                                    <label>TREATMENT SUMMARY AND CLINICAL INDICATION FOR ADDITIONAL TREATMENT</label>
                                </div>
                                ...
                                <div class="row">
                                    <table class="table table-bordered document-table">
                                        ...
                                        <tr>
                                            <td scope="row" class="param-td-title">
                                                <document-textarea
                                                        ...
                                                        label="Observed and reported <b><u>clinical symptoms</u></b> (reference DSM V) in last 2 weeks support the diagnosis/es noted above"
                                            ...
                                            <td class="param-td">
                                                <select class="dropdown-form-control"
                                                        @change="setHasValue"
                                                        v-model="form_data.clinical_symptoms_select"
                                                        :disabled="statuses.editingDisabled"
                                                >
                                                    <option value="None"></option>
                                                    <option>Yes</option>
                                        ...
                                        <tr>
                                            <td scope="row" class="param-td-title">
                                                <document-textarea
                                                        ...
                                                        label="<b>Compared to this patient’s baseline, functioning in
                                                               every day life</b> is compromised. (including but not
                                                               limited to activities of daily living: grooming,
                                                               hygiene, eating, sleeping; ability to manage various
                                                               roles: family, friend, employee, community member;
                                                               ability to work or function in school; etc)"
                                                        v-model="form_data.patient_baseline"
                                                        @change="setHasValue"
                                                        :disabled="statuses.editingDisabled"
                                                ></document-textarea>
                                            </td>
                                            <td class="param-td">
                                                <select class="dropdown-form-control"
                                                        @change="setHasValue"
                                                        v-model="form_data.patient_baseline_select"
                                                        :disabled="statuses.editingDisabled"
                                                >
                                                    <option value="None"></option>
                                                    <option>Yes</option>
                                        ...
                                        <tr>
                                            <td scope="row" class="param-td-title">
                                                <document-textarea
                                                        name="improve_condition"
                                                        label="It is likely that the presenting mental health condition will improve with continued treatment"
                                                        v-model="form_data.improve_condition"
                                                        @change="setHasValue"
                                                        :disabled="statuses.editingDisabled"
                                                ></document-textarea>
                                            </td>
                                            <td class="param-td">
                                                <select class="dropdown-form-control"
                                                        @change="setHasValue"
                                                        v-model="form_data.improve_condition_select"
                                                        :disabled="statuses.editingDisabled"
                                                >
                                                    <option value="None"></option>
                                                    <option>Yes</option>
                                        ...
                                        <tr>
                                            <td scope="row" class="param-td-title">
                                                <document-textarea
                                                        name="without_continued"
                                                        label="<b>OR</b> It is likely that the presenting mental health condition will significantly deteriorate without continued individual psychotherapy"
                                                        v-model="form_data.without_continued"
                                                        @change="setHasValue"
                                                        :disabled="statuses.editingDisabled"
                                                ></document-textarea>
                                            </td>
                                            <td class="param-td">
                                                <select class="dropdown-form-control"
                                                        @change="setHasValue"
                                                        v-model="form_data.without_continued_select"
                                                        :disabled="statuses.editingDisabled"
                                                >
                                                    <option value="None"></option>
                                                    <option>Yes</option>
                                ...
                                <div class="row">
                                    <p>
                                        *Note that patients with risk factors or needing additional services must be
                                        reviewed directly with an OSM Clinical Liaison: contact information available
                                        on “Quick Reference” provided by Behavioral Health
                                    </p>
                                </div>
...
//                    discharge_treatment: null,
                    ...
                    improve_condition: null,
                    without_continued: null,
                    clinical_symptoms_select: this.emptySelect,
                    patient_baseline_select: this.emptySelect,
                    improve_condition_select: this.emptySelect,
                    without_continued_select: this.emptySelect,
                    primary_coverage_select: this.emptySelect,
                    diagnosis_has_been_changed_select: this.emptySelect,
                    first_renewal_select: this.emptySelect,
                    mrn: null,
        ...
        mounted() {
            let self = this;
            let menu_item_selector = 'kp1-request-for-reauthorization-wh';
