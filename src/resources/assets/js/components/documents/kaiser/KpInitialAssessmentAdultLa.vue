                    ...
                    <div class="modal-body">
                        <div class="section section-add-note">
                            <form class="form-note from-document" novalidate>
                                ...
                                <div class="row ">
                                    <document-textarea
                                            name="risk_of_decompensation"
                                            label="Risk of decompensation up to and including hospitalization"
                                            labelClass="z-index-30"
                                            v-model="form_data.risk_of_decompensation"
                                            @change="setHasValue"
                                            :disabled="statuses.editingDisabled"
                                    ></document-textarea>
                                </div>
...
<!--                                        />-->
                                ...
                                <div class="row ">
                                    ...
                                    <document-textarea
                                            ...
                                            labelClass="z-index-30"
                                            v-model="form_data.return_interval"
                                            @change="setHasValue"
                                            :disabled="statuses.editingDisabled"
                                    ></document-textarea>
                                    <document-textarea
                                            name="additional_treatment_needed"
                                            label="Additional treatment needed (Medication referral, group, higher level of care)"
                                            labelClass="z-index-30"
                                            v-model="form_data.additional_treatment_needed"
                                            @change="setHasValue"
                                            :disabled="statuses.editingDisabled"
                                    ></document-textarea>
                                    <document-textarea
                                            name="goal_directed_therapy"
                                            label="Goal directed therapy with initial focus on"
                                            labelClass="z-index-30"
                                            v-model="form_data.goal_directed_therapy"
                                            @change="setHasValue"
                                            :disabled="statuses.editingDisabled"
                                    ></document-textarea>
                                </div>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                document_name: 'kp-initial-assessment-adult-la',
                document_title: 'KP Initial Assessment (Adult) - Los Angeles',
        ...
        beforeMount(){
            if(!this.form_data && this.$store.state.currentDocument){
                ...
                this.form_data = {
                    ...
                    risk_of_decompensation: null,
                    return_interval: null,
                    additional_treatment_needed: null,
                    goal_directed_therapy: null,
                    //diagnoses
        ...
        mounted() {
            let self = this;
            let menu_item_selector = 'kp-initial-assessment-adult-la';
