                            ...
                            <form class="form-note from-document" novalidate>
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-6 input-container input-container-diagnosis">
                                    ...
                                    <div class="fastselect-disabled" v-if="statuses.editingDisabled || !!this.$store.state.currentDocumentData"></div>
                                    ...
                                    <table class="table borderless">
                                      ...
                                      <tr>
                                        <td>
                                          <label class="checkbox-inline">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.increase_num_of_sessions_cb" :disabled="statuses.editingDisabled"
                                                   @change="setHasValue">
                                        ...
                                        <td>
                                          <label class="checkbox-inline">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.php_cb" @change="setHasValue" :disabled="statuses.editingDisabled">
                                      ...
                                      <tr>
                                        <td>
                                          <label class="checkbox-inline">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.iop_cb" :disabled="statuses.editingDisabled"
                                                   @change="setHasValue">
                                ...
                                <div class="row input-row">
                                  <document-textarea
                                    label="Current symptoms, behaviors and stressors if any"
                                    size="col-md-12"
                                ...
                                <div class="row input-row">
                                  <document-textarea
                                    label="How are the patient's symptoms impacting daily functioning"
                                    size="col-md-12"
                                    v-model="form_data.how_symptoms_impacting"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    ...
                                    size="col-md-12"
                                    v-model="form_data.treatment_duration"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    label="Frequency of sessions currently provided"
                                    size="col-md-12"
                                    v-model="form_data.session_frequency"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    ...
                                    size="col-md-12"
                                    v-model="form_data.barriers_to_treatment"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    label="Treatment modality being utilized"
                                    size="col-md-12"
                                ...
                                <div class="row input-row">
                                  <document-textarea
                                    ...
                                    size="col-md-12"
                                    v-model="form_data.treatment_goal"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                ...
                                <div class="row ">
                                  <label>For increase number of sessions only</label>
                                </div>
                                ...
                                <div class="row input-row">
                                  <document-textarea
                                    label="Frequency of sessions currently provided"
                                    size="col-md-12"
                                    v-model="form_data.session_frequency_2"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    label="How will increasing sessions to 2x/week assist the patient in meeting treatment goal?"
                                    size="col-md-12"
                                    v-model="form_data.how_increase_assist"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row input-row">
                                  <document-textarea
                                    label="How long do you (clinician) anticipate extra therapy sessions being necessary?"
                                    size="col-md-12"
                                    v-model="form_data.how_long_extra_therapy_needed"
                                    @change="setHasValue"
                                    :disabled="statuses.editingDisabled"
                                  ></document-textarea>
                                </div>
                                <div class="row ">
                                  <b style="font-size:12px;"><i>Please note, if more sessions beyond the 2-week period are needed consider a higher level of care program.</i></b>
                                </div>
                                <br />
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        document_name: 'kp-ref-to-hloc-la',
        document_title: 'Referral to Higher Level of Care',
        statuses: {
    ...
    beforeMount(){
      if(!this.form_data && this.$store.state.currentDocument){
        ...
        this.form_data = {
          ...
          increase_num_of_sessions_cb: false,
          php_cb: false,
          iop_cb: false,
          dbt_cb: false,
          current_symptoms: null,
          how_symptoms_impacting: null,
          treatment_duration: null,
          session_frequency: null,
          barriers_to_treatment: null,
          treatment_modality: null,
          treatment_goal: null,

          session_frequency_2: null,
          how_increase_assist: null,
          how_long_extra_therapy_needed: null,
    ...
    mounted() {
      let self = this;
      let menu_item_selector = 'kp-ref-to-hloc-la';
