...
<script>
    ...
    export default {
        ...
        data(){
            return{
                document_name: 'kp-patient-discharge-summary-la',
                document_title: 'KP Patient Discharge Summary - Los Angeles',
                emptySelect: 'None',
                statuses: {
        ...
        mounted() {
            let self = this;
            let menu_item_selector = 'kp-patient-discharge-summary-la';
