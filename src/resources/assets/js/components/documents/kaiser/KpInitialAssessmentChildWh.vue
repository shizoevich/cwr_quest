                        ...
                        <div class="row last-row">
                            ...
                            <div class="col-lg-12">
                                <h4 class="modal-title">
                                    Child and Adolescent Psychiatry Department - Woodland Hills
                                </h4>
                            </div>
                            <div class="col-lg-12">
                                <h4 class="modal-title">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                document_name: 'kp-initial-assessment-child-wh',
                document_title: 'KP Initial Assessment (Child) - Woodland Hills',
            }
        },
        beforeMount(){
        ...
        mounted() {
            let self = this;
            let menu_item_selector = 'kp-initial-assessment-child-wh';
