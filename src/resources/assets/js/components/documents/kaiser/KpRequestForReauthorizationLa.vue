                    ...
                    <div class="modal-header">
                        ...
                        <div class="row last-row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <p>
                                    **FORM IS DUE <u>14 DAYS</u> PRIOR TO EXPIRATION OF CURRENT AUTHORIZATON**
                                </p>
                                <p>
                            ...
                            <form class="form-note from-document" novalidate>
                                ...
                                <div class="row">
                                    <document-textarea
                                            ...
                                            label="With continued treatment, how likely is it that the presenting mental health condition will improve? Why or why not?"
                                ...
                                <div class="row">
                                    <document-textarea
                                            name="risk_factors"
                                            label="Describe and clarify <b>risk factors</b> if any (include and <u>explain</u> harm to self, harm to others, risk for decompensation or regression)"
                                ...
                                <div class="row">
                                    <document-textarea
                                            ...
                                            label="2-3 agreed upon SMART goal(s) going forward
                                                   <i>Specific, Measurable, Attainable, Realistic, Time-Limited</i>"
                                ...
                                <div class="row">
                                    <document-textarea
                                            ...
                                            label="Additional Kaiser services recommended (medication evaluation, group therapy or workshop assessment, higher level of care assessment) – please be specific"
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                document_name: 'kp-request-for-reauthorization-la',
                document_title: 'KP Request for Reauthorization - Los Angeles',
                emptySelect: 'None',
                statuses: {
        ...
        mounted() {
            let self = this;
            let menu_item_selector = 'kp-request-for-reauthorization-la';
