                                  ...
                                  <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   ...
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   Tx for chronic or acute symptoms causing major impairment in current functioning
                                      </label>
                                    </div>
                                    <div class="col-md-12">
                                      <label class="font-weight-normal">
                                      ...
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.mild_depression_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   Adjunctive Tx for mild depression (PHQ9 score of 5-19)
                                      </label>
                                    </div>
                                      <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   ...
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   Adjunctive Tx for mild anxiety (GAD 7 score of 5-14 if PHQ9 of 5-19)
                                      </label>
                                    </div>
                                    <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.evaluation_non_complicated_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   ADHD evaluation --Non-Complicated ADHD
                                      </label>
                                    </div>
                                    <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.evaluation_complicated_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   ADHD evaluation for --Complicated ADHD
                                      </label>
                                    </div>
                                    <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.primary_care_provider_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   Previous Failed PCP (Primary Care Provider) medication trials
                                      </label>
                                    </div>
                                    <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.kp_medical_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   KP MediCal patient
                                      </label>
                                ...
                                <div class="row">
                                  ...
                                  <br />
                                   <div class="col-md-12">
                                      <label class="font-weight-normal">
                                            <input type="checkbox" class="checkbox-form-control"
                                                   v-model="form_data.medication_referral_cb"
                                                   @change="setHasValue" 
                                                   :disabled="statuses.editingDisabled">
                                                   Patient agrees to a medication referral
                                      </label>
                                  </div>
                                </div>
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        document_name: 'kpep-medication-evaluation-referral',
        document_title: 'KPEP Kaiser Permanente Medication Consultation Referral',
        statuses: {
    ...
    beforeMount(){
      if(!this.form_data && this.$store.state.currentDocument){
        ...
        this.form_data = {
          ...
          evaluation_non_complicated_cb: false,
          evaluation_complicated_cb: false,
          primary_care_provider_cb: false,
          kp_medical_cb: false,
          patient_other_pertinent_information: null, 
          initial_assessment_tridiuum_cb: false,
          medication_referral_cb: false,
    ...
    mounted() {
      let self = this;
      let menu_item_selector = 'kpep-medication-evaluation-referral';
