            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="table-responsive" v-if="!loading.emails">
                        <table class="table table-striped table-condensed" id="fax-statistic-table">
                            <thead>
                            <tr>
        ...
        methods: {
            initTable() {
                ...
                window.setTimeout(() => {
                    ...
                    this.table = $('#fax-statistic-table').DataTable({
                        'paging': true,
                        'pageLength': 15,
                        'lengthChange': false,
                        'searching': true,
            ...
            updateStatistic() {
                ...
                this.$store.dispatch("getSentFaxesStatistic", payload).then(response => {
