<template>
    <div class="modal modal-vertical-center fade" data-backdrop="static" data-keyboard="false"
         id="cancel-unlock-request-modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Decline Unlock Request</h5>
                </div>
                <div class="modal-body">
                    <p>You are about to decline unlock request. Please confirm.</p>
                    <div id="reason-group">
                ...
                <div class="modal-footer">
                    ...
                    <form action="/dashboard/patient-note-unlock-requests/decline" method="post"
...
<script>
    export default {
        ...
        methods: {
            ...
            closeModal() {
                $('#cancel-unlock-request-modal').modal('hide');
                this.reason = '';
                this.clearValidation();
            }
        },
