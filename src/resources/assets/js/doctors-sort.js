...
$(document).ready( function () {
    let doctorsTable = $('#doctorsTable').dataTable({
        ...
        columns: [
            ...
            {data: 'emailFormatted', orderable: true, searchable: true},
            {data: 'tridiuum', orderable: false, searchable: false},
            {data: 'status', orderable: true, searchable: false},
            {data: 'supervision', orderable: true, searchable: false},
            {data: 'totalWorkedYears', orderable: false, searchable: false},
