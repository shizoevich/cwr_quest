...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // if ($this->input('subscriber_id') && $this->input('subscriber_id') !== $this->patient->subscriber_id) {
        //     $rules['subscriber_id'] .= "|unique:patients,subscriber_id,{$this->patient->id}|unique:patient_leads,subscriber_id,{$this->patient->id},patient_id";
        // }
